...
urlpatterns = [
    ...
    path('analytics/platform/', PlatformAnalyticsAPIView.as_view(), name='analytics-platform'),
    path('analytics/query/', DatasetQueryAPIView.as_view(), name='analytics-query'),
    path('analytics/reports/', SavedReportListCreateAPIView.as_view(), name='analytics-reports'),
    path('analytics/reports/<int:report_id>/', SavedReportDetailAPIView.as_view(), name='analytics-report-detail'),
    path('analytics/dashboard-pref/', DashboardPreferenceAPIView.as_view(), name='analytics-dashboard-pref'),
]
